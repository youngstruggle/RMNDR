...
<body>
	<div class="custom-container">
				...
				<c:forEach items="${customerlist}" var="cust">
					<tr>
						...
						<td><a class="btn btn-primary"
							href="${pageContext.request.contextPath}/customeredit/${cust.customerId}">Update</a></td>
						<td><a class="btn btn-danger"
							href="${pageContext.request.contextPath}/customerdelete/${cust.customerId}">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		...
		<div class="pull-left">
			<a href="${pageContext.request.contextPath}/createcustomerform.html"
