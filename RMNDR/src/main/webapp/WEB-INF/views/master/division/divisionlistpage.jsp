...
<body>
	<div class="container">
		...
		<table class="table" style="margin-top: -1.3em;">
			...
			<tbody>
				<c:forEach items="${divisionlist}" var="divisi">
					<tr>
						<td>${divisi.divisionName}</td>
						<td><a class="btn btn-primary"
							href="${pageContext.request.contextPath}/divisionedit/${divisi.divisionId}">Update</a></td>
						<td><a class="btn btn-danger"
							href="${pageContext.request.contextPath}/divisiondelete/${divisi.divisionId}">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		...
		<div class="pull-left">
			<a href="${pageContext.request.contextPath}/createdivisionform.html"
				class="btn btn-primary">Create Division </a>
		</div>
	</div>
